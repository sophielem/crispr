...
echo "main.c -i $gi -o $gni -l $rfg/index" > ./cmd.txt
main.c -i $gi -o $gni -l $rfg/index 2>> ./allgenomes.err 1> ./allgenomes.log
echo "post_processing.py -file ... -sl 20 -pam \"NGG\" -gi \"$gi\" -gni \"$gni\"" >> ./cmd.txt
post_processing.py -file ... -sl 20 -pam "NGG" -gi $gi -gni $gni 2>> ./allgenomes.err 1> ./allgenomes.log
